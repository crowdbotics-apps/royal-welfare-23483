"""royal_welfare_23483 URL Configuration
...
admin.site.site_header = "Royal Welfare"
admin.site.site_title = "Royal Welfare Admin Portal"
admin.site.index_title = "Royal Welfare Admin"

# swagger
api_info = openapi.Info(
    title="Royal Welfare API",
    default_version="v1",
    description="API documentation for Royal Welfare App",
)
